    ...
    return (
        <div className="flex flex-wrap flex-col items-center gap-4">
            ...
            <section className="flex flex-col items-center justify-center mt-4 lg:mt-10 w-[95%] bg-white rounded-xl shadow-lg p-10">
                ...
                <div className="flex flex-col items-center justify-center lg:flex-row mt-10 gap-5 w-full">
                    <div className="w-full lg:w-3/5">
                        <h4 className="text-xl font-semibold tracking-tight text-gray-900">Send us a message</h4>
                        <form className="flex flex-col gap-4 mt-4">
                            <input type="text" placeholder="Email" className="px-4 py-2 border border-gray-700 rounded-lg" />
                            <textarea placeholder="Message" rows={5} className="px-4 py-2 border border-gray-700 rounded-lg"></textarea>
                            <button onClick={() => alert("Mensaje enviado")} className="px-4 py-2 bg-blue-600 text-white rounded-lg">Send</button>
                        </form>
                    </div>
                </div>
            </section>
